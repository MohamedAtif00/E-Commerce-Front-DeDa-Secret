...
export class AdministrationComponent implements OnInit {
  ...
  welcomeMessage: WelcomeMessage = { title_Eng: '', title_Arb: '', desc_Eng: '', desc_Arb: '' }
  
  // Description Message Section
  descriptionMessageLang:string = 'en'
  descriptionMessage: GetDescription = { title_eng: '', title_arb: '', desc_eng: '', desc_arb:''}
  ...
  // Color Section
  ColorSelected(): void {
    this.adminService.ChangeWebsiteColor(this.selectedColor).subscribe(data => {
  ...
  SaveWelcomeMessage(): void {
    this.adminService.SetWelcomeMessage(this.welcomeMessage).subscribe(data => {
      if (data.isSuccess) {
        this.welcomeMessage = { title_Eng: '', title_Arb: '', desc_Eng: '', desc_Arb: '' };
  ...
  {   
    ...
    {
      title_Eng: this.descriptionMessage.title_eng,
      title_Arb: this.descriptionMessage.title_arb,
      desc_Eng: this.descriptionMessage.desc_eng,
      desc_Arb:this.descriptionMessage.desc_arb
    }
