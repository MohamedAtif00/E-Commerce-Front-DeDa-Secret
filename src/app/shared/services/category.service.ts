...
export class CategoryService {
    ...
    private _getSingleCategory = development.localhosts.category.getSingleCategory
    ...
    {
        return this._http.genericPostAPIData<GeneralResponse<any>>(this._addCategory, {name});
    }

    GetAllCategories()
    {
        return this._http.genericGetAPIData<GeneralResponse<Category[]>>(this._getAllCategories)
    }

    GetSingleCategory(id:string)
    { 
        return this._http.genericGetAPIData<GeneralResponse<any>>(this._getSingleCategory+id);
    }
